...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        mainStackView.addArrangedSubview(wakeUpTitle) // stack view is special. it is non drawing uiview subclass
        //they dont render themselves to the screen we dont add a view to another view we use stackview as a autolayout system
        //to handle positioning things on the screen correctly for us. load them top to bottom or whatever you want to do
        
        //add datepicker below
        ...
        sleepTitle.font = UIFont.preferredFont(forTextStyle: .headline) //dynamic to user setting so better
        ...
        //stepper is plus and minus thing
    ...
    @objc func sleepAmountChanged() {
        sleepAmountLabel.text = String(format: "%g hour", sleepAmountTime.value)
    }
    ...
    @objc func calculateBedTime() {
        ...
        do {
            // pull out component from the date picker
